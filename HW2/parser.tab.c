...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ID = 21,                        /* ID  */
  YYSYMBOL_NUM = 22,                       /* NUM  */
  YYSYMBOL_NUM_B = 23,                     /* NUM_B  */
  YYSYMBOL_STRING = 24,                    /* STRING  */
  YYSYMBOL_OR = 25,                        /* OR  */
  YYSYMBOL_AND = 26,                       /* AND  */
  YYSYMBOL_NOT = 27,                       /* NOT  */
  YYSYMBOL_ASSIGN = 28,                    /* ASSIGN  */
  YYSYMBOL_RELOP_LOW = 29,                 /* RELOP_LOW  */
  YYSYMBOL_RELOP_HIGH = 30,                /* RELOP_HIGH  */
  YYSYMBOL_BINOP_LOW = 31,                 /* BINOP_LOW  */
  YYSYMBOL_BINOP_HIGH = 32,                /* BINOP_HIGH  */
  YYSYMBOL_IFX = 33,                       /* IFX  */
  YYSYMBOL_ELSE = 34,                      /* ELSE  */
  YYSYMBOL_ID_AS_VALUE = 35,               /* ID_AS_VALUE  */
  YYSYMBOL_LPAREN = 36,                    /* LPAREN  */
  YYSYMBOL_CASTING = 37,                   /* CASTING  */
...
{
       0,    70,    70,    73,    74,    81,    92,    93,    96,    97,
     100,   101,   108,   116,   117,   124,   125,   131,   138,   144,
     151,   162,   163,   164,   169,   175,   182,   188,   189,   192,
     198,   205,   206,   213,   214,   215,   218,   219,   226,   233,
     241,   242,   243,   244,   245,   246,   247,   248,   253,   259,
     268,   275,   283
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SC", "COMMA", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", "ID",
  "NUM", "NUM_B", "STRING", "OR", "AND", "NOT", "ASSIGN", "RELOP_LOW",
  "RELOP_HIGH", "BINOP_LOW", "BINOP_HIGH", "IFX", "ELSE", "ID_AS_VALUE",
  "LPAREN", "CASTING", "$accept", "Program", "Funcs", "FuncDecl",
...
{
     117,   -31,   -31,   -31,   -31,     5,   -31,   117,   -15,   -31,
     -31,   -31,    -7,   162,    25,   -31,    36,    19,    53,   162,
     -31,   188,   -31,    65,    28,    33,    60,    62,   188,    -4,
     152,   -31,    63,    61,   -31,   -31,   -31,    -9,   -31,   -31,
     -31,    90,    12,   -31,    24,    90,    90,   -31,   -31,   170,
      90,    90,    83,   -31,   -31,   -31,    47,    90,   114,    68,
     192,   -31,    90,    90,    90,    90,    90,    90,   200,   211,
     -31,   219,   102,   -31,    69,   181,   -31,    90,    90,   227,
      90,   -31,   -18,   114,   154,   -30,    49,   -31,   188,   188,
      67,   -31,   -31,    90,   235,   110,   -31,   -31,    59,   -31,
      90,   -31,    82,   -31,   188,   123,   -31,   -31,   -31
};
...
static const yytype_int8 yydefact[] =
{
      ...
      12,     0,    11,     0,     0,     0,     0,     0,     0,     0,
       0,    13,     0,     0,    45,    46,    22,    40,    42,    43,
      44,     0,     0,    41,     0,     0,     0,    27,    28,     0,
       0,     0,     0,     5,    14,    21,     0,     0,    47,     0,
       0,    23,     0,     0,     0,     0,     0,     0,     0,     0,
      15,     0,     0,    30,     0,    31,    16,     0,     0,     0,
       0,    36,    49,    48,    50,    51,    38,    39,     0,     0,
       0,    18,    29,     0,     0,     0,    37,    52,    24,    26,
       0,    32,     0,    17,     0,     0,    20,    25,    19
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -31,   -31,    93,   -31,   -31,   -31,    84,   -31,    74,   -26,
     -21,    15,    52,   -20
};
...
{
      32,    66,    67,    44,    54,    10,    12,    32,    63,    32,
      57,    64,    65,    66,    67,    50,     2,     3,     4,    34,
      35,    58,    60,    54,    51,    68,    69,    52,    32,    13,
      71,    72,    52,    37,    38,    39,    40,    79,    61,    41,
      20,    18,    82,    83,    84,    85,    86,    87,    42,    62,
      63,    19,     9,    64,    65,    66,    67,    94,    95,     9,
      97,    76,    98,    99,    45,    17,    77,    32,    32,    46,
      21,    17,    34,    35,    47,    78,    48,    55,   107,    36,
     105,    67,    56,    32,    80,    92,    37,    38,    39,    40,
      34,    35,    41,   104,    59,   100,   106,    34,    35,    73,
      11,    42,    49,    22,    37,    38,    39,    40,   101,     0,
      41,    37,    38,    39,    40,     0,    91,    41,     0,    42,
       1,     2,     3,     4,   103,     0,    42,    62,    63,     0,
       0,    64,    65,    66,    67,    62,    63,   108,     0,    64,
      65,    66,    67,    64,    65,    66,    67,     0,    62,    63,
       0,     0,    64,    65,    66,    67,     2,     3,     4,     0,
       0,    23,    24,    25,    26,    27,     2,     3,     4,    28,
      53,     0,     0,    29,     2,     3,     4,     0,     0,    23,
      24,    25,    26,    27,    65,    66,    67,    28,    70,     0,
       0,    29,     2,     3,     4,     0,    93,    23,    24,    25,
      26,    27,     0,     0,     0,    28,    62,    63,    81,    29,
      64,    65,    66,    67,     0,     0,    88,    62,    63,     0,
       0,    64,    65,    66,    67,    62,    63,    89,     0,    64,
      65,    66,    67,     0,     0,     0,    62,    63,     0,    90,
      64,    65,    66,    67,    62,    63,     0,    96,    64,    65,
      66,    67,    62,    63,     0,   102,    64,    65,    66,    67,
      62,    63,     0,     0,    64,    65,    66,    67
};

static const yytype_int8 yycheck[] =
{
      21,    31,    32,    23,    30,     0,    21,    28,    26,    30,
      19,    29,    30,    31,    32,    19,     4,     5,     6,     7,
       8,    41,    42,    49,    28,    45,    46,    36,    49,    36,
      50,    51,    36,    21,    22,    23,    24,    57,    14,    27,
      21,    16,    62,    63,    64,    65,    66,    67,    36,    25,
      26,    15,     0,    29,    30,    31,    32,    77,    78,     7,
      80,    14,    88,    89,    36,    13,    19,    88,    89,    36,
      17,    19,     7,     8,    14,    28,    14,    14,   104,    14,
     100,    32,    21,   104,    16,    16,    21,    22,    23,    24,
       7,     8,    27,    34,    42,    28,    14,     7,     8,    16,
       7,    36,    28,    19,    21,    22,    23,    24,    93,    -1,
      27,    21,    22,    23,    24,    -1,    14,    27,    -1,    36,
       3,     4,     5,     6,    14,    -1,    36,    25,    26,    -1,
      -1,    29,    30,    31,    32,    25,    26,    14,    -1,    29,
      30,    31,    32,    29,    30,    31,    32,    -1,    25,    26,
      -1,    -1,    29,    30,    31,    32,     4,     5,     6,    -1,
      -1,     9,    10,    11,    12,    13,     4,     5,     6,    17,
      18,    -1,    -1,    21,     4,     5,     6,    -1,    -1,     9,
      10,    11,    12,    13,    30,    31,    32,    17,    18,    -1,
      -1,    21,     4,     5,     6,    -1,    15,     9,    10,    11,
      12,    13,    -1,    -1,    -1,    17,    25,    26,    16,    21,
      29,    30,    31,    32,    -1,    -1,    16,    25,    26,    -1,
      -1,    29,    30,    31,    32,    25,    26,    16,    -1,    29,
      30,    31,    32,    -1,    -1,    -1,    25,    26,    -1,    20,
      29,    30,    31,    32,    25,    26,    -1,    20,    29,    30,
      31,    32,    25,    26,    -1,    20,    29,    30,    31,    32,
      25,    26,    -1,    -1,    29,    30,    31,    32
};
...
static const yytype_int8 yystos[] =
{
       ...
       0,    40,    21,    36,    43,    44,    45,    50,    16,    15,
      21,    17,    44,     9,    10,    11,    12,    13,    17,    21,
      46,    47,    48,    50,     7,     8,    14,    21,    22,    23,
      24,    27,    36,    48,    51,    36,    36,    14,    14,    46,
      19,    28,    36,    18,    47,    14,    21,    19,    51,    50,
      51,    14,    25,    26,    29,    30,    31,    32,    51,    51,
      18,    51,    51,    16,    49,    51,    14,    19,    28,    51,
      16,    16,    51,    51,    51,    51,    51,    51,    16,    16,
      20,    14,    16,    15,    51,    51,    20,    51,    47,    47,
      28,    49,    20,    14,    34,    51,    14,    47,    14
};
...
#line 101 "parser.y"
                                 { 
            auto formalsList = std::dynamic_pointer_cast<ast::Formals>(yyvsp[0]);
            formalsList->push_front(std::dynamic_pointer_cast<ast::Formal>(yyvsp[-2]));
            yyval = formalsList;
        }
...
#line 151 "parser.y"
                                 { 
            auto primitiveType = std::dynamic_pointer_cast<ast::PrimitiveType>(yyvsp[-5]);
            auto type = std::make_shared<ast::ArrayType>(
                primitiveType->type,
                std::dynamic_pointer_cast<ast::Exp>(yyvsp[-2])
            );
            yyval = std::make_shared<ast::VarDecl>(
                std::dynamic_pointer_cast<ast::ID>(yyvsp[-4]),
                type
            );
        }
...
#line 1529 "parser.tab.c"
  ...
  case 38: /* Exp: Exp BINOP_LOW Exp  */
#line 226 "parser.y"
                      {
            yyval = std::make_shared<ast::BinOp>(
                std::dynamic_pointer_cast<ast::Exp>(yyvsp[-2]),
                std::dynamic_pointer_cast<ast::Exp>(yyvsp[0]),
                std::dynamic_pointer_cast<ast::BinOp>(yyvsp[-1])->op
            );
        }
#line 1541 "parser.tab.c"
    break;

  case 39: /* Exp: Exp BINOP_HIGH Exp  */
#line 233 "parser.y"
                        {
            yyval = std::make_shared<ast::BinOp>(
                std::dynamic_pointer_cast<ast::Exp>(yyvsp[-2]),
...
#line 1627 "parser.tab.c"
  ...
  case 50: /* Exp: Exp RELOP_LOW Exp  */
#line 268 "parser.y"
                      { 
            yyval = std::make_shared<ast::RelOp>(
                std::dynamic_pointer_cast<ast::Exp>(yyvsp[-2]),
                std::dynamic_pointer_cast<ast::Exp>(yyvsp[0]),
                std::dynamic_pointer_cast<ast::RelOp>(yyvsp[-1])->op
            );
        }
#line 1639 "parser.tab.c"
    break;

  case 51: /* Exp: Exp RELOP_HIGH Exp  */
#line 275 "parser.y"
                        { 
            yyval = std::make_shared<ast::RelOp>(
                std::dynamic_pointer_cast<ast::Exp>(yyvsp[-2]),
